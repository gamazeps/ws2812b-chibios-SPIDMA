 ...
 */
static WORKING_AREA(LEDS_THREAD_WA, 128);
static __attribute__((noreturn)) msg_t ledsThread(void *arg){
  (void) arg;
  while(1){
 ...
 */
static WORKING_AREA(HSVTRANS_WA, 128);
static __attribute__((noreturn)) msg_t hsv_transThread(void *arg){
  (void) arg;
